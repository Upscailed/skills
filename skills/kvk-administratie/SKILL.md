---
name: kvk-administratie
title: "KvK Administratie"
description: "Documenteert de KvK-inschrijving van een Nederlandse onderneming in één gestructureerd bestand. Verzamelt KvK-nummer, BTW-ID, RSIN, rechtsvorm, vestigingsadres, SBI-codes, bestuurders, aandeelhouders en bij BV ook kapitaal. Pre-fillt automatisch uit een geüpload KvK-uittreksel (PDF) of via een KvK-zoek-URL, verifieert of de gegevens nog actueel zijn na adres-wijziging of bestuurswissel, en levert een document dat als bron dient voor Algemene Voorwaarden (J3), Privacyverklaring (J4) en Klantcontracten (J5). Gebruik deze skill altijd wanneer iemand vraagt om KvK vastleggen, KvK-inschrijving documenteren, ondernemingsgegevens vastleggen, BTW-ID opslaan, rechtsvorm bevestigen, vestigingsadres of bestuurders documenteren, zegt 'J1 dichten', 'gat in SCALE-audit voor KvK', 'mijn KvK-gegevens staan nergens', of wanneer een ander juridisch document KvK-data nodig heeft die nog niet vastgelegd is."
category: operations
