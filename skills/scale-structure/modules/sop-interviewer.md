# SOP Interviewer (module van scale-structure)

> Bron-skill: `sop-interviewer` | SCALE-code: S10 | Versie: 1.0.0 | Geschatte tijd: 30 tot 60 minuten (3 tot 5 SOPs in één sessie)
