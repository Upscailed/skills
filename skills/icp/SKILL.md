...
description: "Helpt een ondernemer in 30-45 minuten een rijk, bruikbaar ICP-document op te bouwen in één canoniek bestand: `Directie/Playbook/ICP.md`. Dit is SCALE-stap 4 (Structure) en de scherpe lens waarmee marketing, sales, content en productontwikkeling gericht worden: zonder dit document mikt een AI op iedereen, valt marketing platte, sluiten sales-gesprekken slecht aan op de werkelijke pijn en is ieder klantsegment even belangrijk. De skill werkt via een gestructureerd interview in 8 blokken (Scope-keuze, Harde kenmerken, Zachte kenmerken, Pijnpunten, Triggers en koop-momenten, Beslissingsproces, Niet-ideale klant, Verificatie en bewijsbronnen), één blok per beurt zodat de ondernemer kan nadenken zonder overweldigd te raken. Bij meerdere segmenten loopt het interview iteratief: één segment helemaal uitwerken voordat het volgende begint. Vóór het interview scant de skill diep wat al beschikbaar is, zowel in de vault (Directie/00 - Overzicht, Directie/Playbook/Brand Guidelines, Directie/Playbook/Tone of Voice, Directie/Playbook/Bedrijfsverhaal, Directie/Research/concurrentie en marktanalyse, Sales/CRM-exports, Marketing/Content Roadmap, Klantenservice-tickets) als in externe documenten die de ondernemer aanlevert (website-URL, sales-CRM-export, klant-interviews, marktonderzoek, AI-scan-rapport, eerdere persona-werk). Het werkt vault-onafhankelijk: alle paden zijn relatief aan `{scope}/`, geen hard-coded persoonlijke vault-mappen. Activeer altijd wanneer iemand zegt: 'maak een ICP', 'ideale klant beschrijven', 'doelgroep aanscherpen', 'klantsegmenten uitwerken', 'wie is onze klant precies', 'persona schrijven', 'S4 dichten in SCALE-audit', 'gap S4', 'voor wie doen we dit eigenlijk', 'klantprofiel maken', 'klantbeschrijving uitwerken', 'ideal customer profile', 'sweet spot bepalen', 'aan wie verkopen we'. Triggert ook bij iedere expliciete verwijzing naar S4 of `Directie/Playbook/ICP.md`."
category: structure
tags: [icp, ideal-customer-profile, doelgroep, klantsegmenten, structure, scale-framework, s4, fundament]
