---
name: verzekeringen-overzicht
title: "Verzekeringen Overzicht"
description: "Helpt een Nederlandse MKB-ondernemer in 25 tot 50 minuten een volledig overzicht van zakelijke verzekeringen op te bouwen in één canoniek document: `Juridisch/Verzekeringen.md`. Dit is SCALE-stap J6 (Juridisch) en de bodemplaat van het risico-beheer dat al het latere ondernemen draagt. Zonder dit overzicht weet je niet welke risico's zijn afgedekt, betaal je vaak dubbel voor overlappende dekking, mis je verlopen polissen en is een schadeclaim ineens een chaos. De skill werkt via een gestructureerd interview in 7 categorieen (Aansprakelijkheid, Inventaris en zaken, Mensen, Voertuig en transport, Cyber, Rechtsbijstand, Bestuurders), één categorie per beurt zodat het niet overweldigt. Per categorie wordt eerst gevraagd of die voor het bedrijf relevant is. Voor relevante categorieen wordt per polis vastgelegd: maatschappij, polisnummer, dekking-samenvatting, eigen risico, jaarpremie, einddatum, makelaar of tussenpersoon, claims-status. Vóór het interview begint, scant de skill diep wat al beschikbaar is: in de vault (`Juridisch/` voor bestaande polis-PDFs of overzichten, `Directie/00 - Overzicht.md` voor rechtsvorm en risicocontext, `HR/Team.md` voor personeels-context, `IT/Toolstack.md` voor cyber-context) én in externe documenten die de ondernemer kan aanleveren (polisbladen, jaaroverzicht van de verzekeringsmakelaar, boekhouding-categorie 'verzekeringspremies' over laatste 12 maanden). Na het interview voert de skill een gap-analyse uit op basis van het risico-profiel: een B2B-dienstverlener mist meestal beroepsaansprakelijkheid (BAV), een bedrijf met klantdata mist meestal cyber, een BV-bestuurder mist meestal D&O. Cross-links met SCALE J1 (KvK, rechtsvorm bepaalt deel verzekerings-behoefte), S11 (Team, personeels-verzekeringen) en S12 (Toolstack, cyber hangt af van tools). Werkt vault-onafhankelijk: er worden geen aannames gedaan over een specifieke mapnaam of vault-eigenaar, alleen over de SCALE-Juridisch-conventie (`Juridisch/`, `Directie/`, `HR/`, `IT/`). Belangrijk: dit is een inventarisatie, geen verzekerings-advies. Voor de gap-analyse-conclusies wordt expliciet doorverwezen naar een onafhankelijke verzekeringsmakelaar. Activeer altijd wanneer iemand zegt: 'verzekeringen vastleggen', 'verzekeringen documenteren', 'bedrijfsverzekeringen inventariseren', 'polissen op een rij', 'verzekeringen-overzicht', 'welke verzekeringen heb ik zakelijk', 'check mijn verzekeringen', 'verzekeringen-check', 'J6 dichten in SCALE-audit', 'gap J6', 'Juridisch/Verzekeringen.md aanmaken', 'risico-overzicht bedrijf', 'wat ben ik verzekerd', 'beroepsaansprakelijkheid checken', 'cyber-verzekering bedrijf'. Triggert ook bij iedere expliciete verwijzing naar J6, Verzekeringen.md, of vragen rond polis-vervaldata, dekkingsgrens, eigen risico, en welke risico's nog open staan."
category: operations
tags: [verzekeringen, polissen, juridisch, risico, aansprakelijkheid, cyber, scale-framework, j6]
estimatedTime: "25 tot 50 minuten"
version: "1.0.0"
author: Upscailed
license: MIT
scaleFramework: true
