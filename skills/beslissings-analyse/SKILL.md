---
name: beslissings-analyse
title: "Beslissings-analyse"
description: "Helpt een ondernemer in 45 tot 75 minuten een data-gedreven beslissings-framework op te bouwen in één canoniek document: `{scope}/Analyze/Beslissings-Frameworks.md`. Dit is SCALE-stap A4 (Analyze) en levert geen één-shot keuze-coaching maar een herbruikbare beslis-infrastructuur: per terugkerende strategische beslissing (klant accepteren ja of nee, prijsverhoging doorvoeren, investering in tool, medewerker aannemen, feature wel of niet bouwen, dienst stoppen of doorzetten, leverancier wisselen) wordt vastgelegd welke data eerst geraadpleegd wordt, welke 3 tot 7 harde criteria gewogen worden op een score van 1 tot 5, welke drempelwaarde go versus no-go bepaalt, en wie verplicht meekijkt. Plus een template voor ad-hoc strategische keuzes waar nog geen playbook voor bestaat. De skill scant eerst diep wat al in de vault staat: alle C-laag-data (`Collect/CRM-setup.md` C2, `Collect/Financiele-data.md` C3, `Collect/Klantfeedback.md` C4, `Collect/Operationele-KPIs.md` C7), de richting (`Directie/01 - Goals.md` S5), de meekijker-laag (`Directie/Playbook/Team.md` S11) plus eerdere beslis-rapporten in `Persoonlijk/Intelligence/Beslissingen/` of `Directie/Research/`. De skill werkt vault-onafhankelijk: geen aannames over een specifieke mapnaam of vault-eigenaar. Activeer altijd wanneer iemand zegt: 'beslissings-framework', 'beslis-playbook', 'wanneer accepteer ik een klant', 'wanneer doe ik een prijsverhoging', 'investerings-criteria opzetten', 'aanname-checklist', 'go no-go drempel', 'data-gedreven beslissen', 'beslis-criteria definiëren', 'strategische keuze-template', 'A4 dichten in SCALE-audit', 'gap A4', 'Beslissings-Frameworks.md aanvullen'. Triggert ook bij iedere expliciete verwijzing naar A4 of `Beslissings-Frameworks.md`. Triggert NIET voor één-shot persoonlijke twijfel-coaching, gebruik dan skill `beslissingshulp` (Ben AI meta-skill voor losse grote keuzes). Deze skill is bedoeld voor het opzetten van een beslissings-infrastructuur (terugkerende playbook-catalogus), NIET voor een eenmalige one-shot beslissing. Voor een eenmalige keuze tussen 2-3 opties: gebruik `beslissingshulp`. Twijfel? Vraag eerst of de gebruiker een herhaalbare structuur wil of een eenmalige analyse."
category: operations
