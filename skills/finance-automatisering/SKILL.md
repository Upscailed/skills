---
name: finance-automatisering
title: "Finance Automatisering"
description: "Helpt een ondernemer in 45 tot 90 minuten zes finance-workflows automatiseren in één canoniek document: `{scope}/Leverage/Finance-Automatisering.md`. Dit is SCALE-stap L4 (Leverage) en de operationele opvolger van C3 (Financiele Data Setup) en V1 (Salesproces): waar C3 het cijfer-vocabulaire vastlegt en V1 de pipeline-fases definieert, beschrijft L4 hoe handmatig finance-werk wordt verlegd naar automatiseringen rond facturatie, boekingen, debiteurenbeheer, BTW-voorbereiding, cashflow-forecast en boekhouder-handoff. De zes workflows: (1) Facturatie-automatisering, waarbij een gewonnen deal uit V1 automatisch een factuur in Moneybird of e-Boekhouden creëert en naar de klant wordt gestuurd. (2) Boekingen-automatisering, waarbij bankafschriften via PSD2 automatisch geïmporteerd en gecategoriseerd worden, met een regel-engine voor bekende patronen en AI-fallback voor onduidelijke posten. (3) Debiteuren-beheer, waarbij openstaande facturen automatisch herinneringen krijgen op D+7, D+14 en D+30, met escalatie naar incasso bij D+45 of D+60. (4) BTW-aangifte-voorbereiding, waarbij de kwartaal-cijfers automatisch worden uitgelezen en op de 1e van het volgende kwartaal voor de accountant klaargezet, gekoppeld aan het J2-regime (21% / 9% / vrijgesteld / KOR / OSS). (5) Cashflow-forecast, een wekelijkse rolling-forecast die de pipeline uit V1 (verwachte deals × kans-%) combineert met bestaande recurring-contracten en bekende vaste uitgaven. (6) Boekhouder-handoff, een maandelijks pakket met grootboek-export, vragen-overzicht en anomalieën dat de overdracht naar de boekhouder of Fit In Finance versnelt. Vóór het interview begint, scant de skill diep wat al beschikbaar is: `Collect/Financiele-Data.md` (C3) of `Financiën/Data-Setup.md` voor bronnen, kerncijfers en frequenties, `Sales/Salesproces.md` (V1) voor pipeline-fases en deal-won-trigger, `Juridisch/BTW-administratie.md` (J2) voor regime en aangifte-frequentie, `IT/Toolstack.md` (S12) voor boekhoudpakket en betalingsplatform, `Financiën/Rapportage/` voor bestaande rapportages, en `Operations/Processen/` voor reeds beschreven finance-processen. Tools die de skill expliciet ondersteunt: Moneybird-API, e-Boekhouden-API, Exact-Online-API, Stripe-webhooks, Mollie-webhooks, Cohunt of vergelijkbare PSD2-aggregators voor bank-data, Make of n8n als orkestratie-laag, eventueel custom scripts voor randgevallen. Werkt vault-onafhankelijk: geen aannames over een specifieke mapnaam of vault-eigenaar, alleen over de SCALE-conventie (`Leverage/`, `Financiën/`, `IT/`). Activeer altijd wanneer iemand zegt: 'finance automatiseren', 'factuur automatisch versturen', 'auto-incasso opzetten', 'auto-facturatie', 'betalingsherinneringen automatiseren', 'debiteuren-flow', 'incasso-flow', 'BTW-aangifte voorbereiden', 'cashflow-forecast bouwen', 'boekhouder-pakket maken', 'maandelijkse handoff naar accountant', 'bankafschriften categoriseren', 'PSD2 koppeling', 'L4 dichten in SCALE-audit', 'gap L4', 'Finance-Automatisering.md aanmaken'. Belangrijk: de skill versnelt finance-processen, maar vervangt de fiscale verantwoordelijkheid van een boekhouder of administratiekantoor (zoals Fit In Finance) niet. Bij twijfel over BTW-regime, jaarrekening, balansbeoordeling of fiscale optimalisatie verwijst de skill expliciet door."
category: operations
tags: [scale-framework, l4, leverage, finance, facturatie, boekhouding, debiteuren, btw, cashflow, automatisering]
