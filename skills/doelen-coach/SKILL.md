...
name: "doelen-coach"
title: "Doelen Coach"
description: "Coachende skill die helpt een strategisch doelenplan op te stellen voor één bedrijf. Stelt kritische vragen, daagt uit en bouwt op tot één goals.md met 3-jaar visie, 1-jaar OKR-light en kwartaaldoelen. Werkt vault-onafhankelijk in twee modi: Vault-modus (de skill leest bestaande bedrijfsdocumenten en schrijft naar `{scope}/Directie/goals.md`) en Standalone-modus (de klant uploadt context of vertelt het, output gaat naar door klant gekozen locatie)."
category: structure
tags: [doelen, strategie, okr, 12wy, vivid-vision, scale-framework, s5]
