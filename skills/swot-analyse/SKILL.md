...
name: swot-analyse
title: "SWOT Analyse"
description: "Helpt een ondernemer in 30-50 minuten een rijke SWOT-analyse op te bouwen in één canoniek document: `Directie/Research/SWOT.md`. Dit is SCALE-stap 6 (Structure) en de brug tussen het fundament (S1-S5: identiteit, brand, doelgroep, doelen) en alle latere strategische keuzes. Zonder SWOT mist een ondernemer (en zijn AI-laag) het strategische beeld waarin sterktes en zwaktes bewust ingezet of beschermd worden, en waarin externe kansen en bedreigingen niet alleen genoemd maar ook gekoppeld zijn aan acties. De skill werkt via een gestructureerd interview in 5 blokken (Strengths, Weaknesses, Opportunities, Threats, Cross-analyse/strategische conclusies), één blok per beurt zodat de gebruiker niet wordt overweldigd. Vóór het interview begint scant de skill diep wat al beschikbaar is — vooral `Directie/Research/Concurrentie.md` (output van skill `concurrentie-research`, SCALE C6) die direct de Kansen- en Bedreigingen-secties kan pre-fillen, plus `Directie/00 - Overzicht.md`, `Directie/Playbook/Bedrijfsverhaal.md`, `Directie/01 - Goals.md` en eerdere SWOT-versies — én vraagt actief naar externe documenten (eerdere SWOT, business plan, mentorgesprekken, klantfeedback, marktrapporten). Vault-onafhankelijk: alleen relatieve paden binnen `{scope}/`. Activeer altijd wanneer iemand zegt: 'maak een SWOT', 'SWOT analyse', 'sterktes en zwaktes in kaart brengen', 'kansen en bedreigingen', 'help me een SWOT opzetten', 'strategische analyse', 'S6 dichten in SCALE-audit', 'gap S6', 'cross-analyse maken', 'SO ST WO WT strategieën', 'wat zijn onze sterktes', 'wat moeten we verbeteren', 'waar liggen kansen voor ons bedrijf', 'welke bedreigingen lopen we'. Triggert ook bij iedere expliciete verwijzing naar S6 of `SWOT.md`."
category: structure
tags: [swot, swot-analyse, structure, scale-framework, s6, strategie, cross-analyse, sterktes-zwaktes, kansen-bedreigingen]
