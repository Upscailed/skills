...
description: "Helpt een ondernemer in 30 tot 60 minuten een werkende website-analytics-opzet te kiezen, in te bouwen en te documenteren in één canoniek bestand: `{scope}/Collect/Website-Analytics.md` (of `{scope}/Marketing/Analytics-Setup.md` als die conventie al loopt). Dit is SCALE-stap C5 (Collect) en de basis voor latere Analyze- en Leverage-stappen die kanaal-attributie, conversie en funnel-data nodig hebben. Zonder dit document blijft website-traffic een black box: je weet niet welke campagne werkt, welke pagina lekt, welke knoppen worden geklikt, of welke kanalen leads opleveren. De skill werkt in zes blokken: (1) scope en site-inventaris, (2) tool-keuze met privacy-first als default-advies (Plausible, Fathom, Vercel Analytics, Cloudflare Web Analytics, Umami, Matomo) versus GA4 als gratis maar zwaardere optie inclusief verplichte cookie-consent, (3) event-set op maat van het bedrijfstype (B2B-leadgen, e-commerce, content-publisher, marktplaats, SaaS), (4) UTM-discipline voor kanaal-attributie, (5) AVG-compliance met IP-anonimisering, retentie max 14 maanden en geen PII in events, (6) installatie-stappen, validatie en cross-link naar C1 Marketing Data, J4 Privacyverklaring en A2 Mission Control. Pre-fill: scant `{scope}/IT/Toolstack.md` voor bestaande tools, `{scope}/Marketing/` voor campagne-namen en site-URL, `{scope}/Juridisch/` voor een lopende privacyverklaring en `{scope}/Directie/00 - Overzicht.md` voor proposite-context. Werkt vault-onafhankelijk: alleen relatieve paden binnen `{scope}`. Activeer altijd wanneer iemand zegt: 'website analytics opzetten', 'GA4 opzetten', 'Plausible installeren', 'Fathom', 'Vercel Analytics', 'Cloudflare Web Analytics', 'Umami', 'Matomo', 'events tracken', 'conversie-tracking website', 'funnel meten', 'UTM-tagging', 'wat gebeurt er op mijn site', 'website-data verzamelen', 'C5 dichten in SCALE-audit', 'gap C5', 'Collect/Website-Analytics.md aanmaken', 'cookies en tracking compliant', 'scroll-depth meten', 'time-on-page', 'analytics privacy-vriendelijk', 'GDPR website tracking'. Triggert ook bij iedere expliciete verwijzing naar C5, Website-Analytics.md, of vragen rond welke analytics-tool te kiezen voor een MKB-website."
category: operations
tags: [website, analytics, scale-framework, c5, collect, plausible, ga4, privacy, avg, gdpr, utm, conversion, funnel, events]
