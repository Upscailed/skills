# SOP Automatiseren (module van scale-leverage)

> Bron-skill: `sop-automatiseren` | SCALE-code: L1 | Versie: 1.1.0 | Geschatte tijd: 45 tot 90 minuten (1 tot 5 SOPs in één sessie)
